...
//	CGFloat maxWidth = bounds.size.width - 4 * margin;
    CGFloat maxWidth = bounds.size.width - 90;
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:detailsLabel.font} context:nil].size;
...
- (id)init {
	return [self initWithFrame:CGRectMake(0.f, 0.f, 28.f, 28.f)];
}
